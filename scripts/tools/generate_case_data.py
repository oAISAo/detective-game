...
EVIDENCE = {
    "evidence": [
        # E1 — Murder Weapon (Kitchen Knife)
        {
            ...
            "tags": ["crime_scene", "murder_weapon", "forensic"],
            "weight": 0.9,
        ...
        # E2 — Two Wine Glasses
        {
            ...
            "discovered_day": 0,
            "related_persons": [],
            "tags": ["crime_scene", "visitor", "fingerprints"],
            "weight": 0.5,
        ...
        # E3 — Julia's Fingerprint on Wine Glass (Lab result Day 2)
        {
            ...
            "tags": ["forensic", "fingerprint", "contradiction", "critical"],
            "weight": 0.9,
            "importance_level": "CRITICAL",
        ...
        # E5 — Broken Picture Frame
        {
            ...
            "tags": ["crime_scene", "argument", "relationship"],
            "weight": 0.4,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": ["CONNECTION"]
        ...
        # E6 — Victim's Phone
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_victim"],
            "tags": ["crime_scene", "digital", "phone"],
            "weight": 0.5,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": []
        ...
        # E8 — Deleted Messages (Recovered Later, warrant needed)
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_victim", "p_julia"],
            "tags": ["digital", "warrant", "motive", "hidden"],
            "weight": 0.7,
            "importance_level": "CRITICAL",
        ...
        # E9 — Call Log Between Mark and Daniel
        {
            ...
            "tags": ["digital", "phone", "financial", "motive"],
            "weight": 0.5,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": ["MOTIVE", "CONNECTION"]
        ...
        # E10 — Email From Daniel to Mark
        {
            ...
            "tags": ["digital", "email", "financial", "motive"],
            "weight": 0.6,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": ["MOTIVE", "CONNECTION"]
        ...
        # E11 — Suspicious Bank Transfer
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_mark"],
            "tags": ["financial", "embezzlement", "motive"],
            "weight": 0.8,
            "importance_level": "CRITICAL",
            "discovery_method": "VISUAL",
        ...
        # E15 — Hallway Camera (Blurry Figure)
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_julia"],
            "tags": ["surveillance", "timeline", "blurry"],
            "weight": 0.6,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": ["PRESENCE"]
        ...
        # E16 — Elevator Logs
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_julia"],
            "tags": ["digital", "timeline", "access", "critical"],
            "weight": 0.8,
            "importance_level": "CRITICAL",
            "discovery_method": "VISUAL",
        ...
        # E18 — Sarah's Second Testimony
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_sarah"],
            "tags": ["witness", "testimony", "pressure", "female_voice"],
            "weight": 0.6,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": ["CONNECTION"]
        ...
        # E19 — Lucas Work Log
        {
            ...
            "tags": ["alibi", "work_log", "contradiction"],
            "weight": 0.3,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": ["PRESENCE"]
        ...
        # E20 — Shoe Print in Hallway
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_julia"],
            "tags": ["forensic", "shoe_print", "critical"],
            "weight": 0.8,
            "importance_level": "CRITICAL",
            "discovery_method": "TOOL",
            "requires_lab_analysis": True,
        ...
        # E21 — Julia's Shoes (Search Warrant)
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_julia"],
            "tags": ["forensic", "shoe_match", "warrant", "critical"],
            "weight": 0.8,
            "importance_level": "CRITICAL",
            "discovery_method": "VISUAL",
            "legal_categories": ["PRESENCE", "CONNECTION"],
        ...
        # E23 — Knife Block in Kitchen
        {
            ...
            "discovered_day": 0,
            "related_persons": [],
            "tags": ["crime_scene", "murder_weapon"],
            "weight": 0.3,
            "importance_level": "SUPPORTING",
            "discovery_method": "VISUAL",
            "legal_categories": []
        ...
        # E24 — Hidden Safe in Office
        {
            ...
            "discovered_day": 0,
            "related_persons": ["p_mark", "p_victim"],
            "tags": ["hidden", "embezzlement", "motive", "critical"],
            "weight": 0.85,
            "importance_level": "CRITICAL",
            "discovery_method": "VISUAL",
            "legal_categories": ["MOTIVE"],
        ...
        # E25 — Daniel's Personal Journal
        {
            ...
            "tags": ["personal", "motive", "critical", "journal"],
            "weight": 0.85,
            "importance_level": "CRITICAL",
            "discovery_method": "VISUAL",
            "legal_categories": ["MOTIVE", "CONNECTION"],
