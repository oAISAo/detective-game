...
2. I don't like how desk Drawer just appears after the safe has been found. When the Desk Drawer unlocks, instead of just appearing silently let's implement a Brief target reveal animation:
