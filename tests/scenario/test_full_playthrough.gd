...
var _test_case_data: Dictionary = {
	...
	"evidence": [
		{"id": "ev_knife", "name": "Kitchen Knife", "description": "Murder weapon.", "type": "OBJECT", "discovery_method": "VISUAL", "location_found": "loc_scene", "related_persons": ["p_mark"], "weight": 0.9, "importance_level": "REQUIRED", "legal_categories": ["PRESENCE"]},
		{"id": "ev_dna", "name": "DNA Results", "description": "DNA on weapon.", "type": "FORENSIC", "discovery_method": "FORENSIC", "location_found": "lab", "related_persons": ["p_mark"], "weight": 0.95, "importance_level": "REQUIRED", "legal_categories": ["CONNECTION"]},
		{"id": "ev_insurance", "name": "Insurance Policy", "description": "Financial motive.", "type": "DOCUMENT", "discovery_method": "VISUAL", "location_found": "loc_office", "related_persons": ["p_mark"], "weight": 0.85, "importance_level": "REQUIRED", "legal_categories": ["MOTIVE"]},
		...
		{"id": "ev_prints", "name": "Shoe Prints", "description": "At scene.", "type": "OBJECT", "discovery_method": "VISUAL", "location_found": "loc_scene", "related_persons": ["p_mark"], "weight": 0.6, "importance_level": "MAJOR", "legal_categories": ["PRESENCE"]},
		{"id": "ev_glass", "name": "Wine Glass", "description": "Fingerprints.", "type": "OBJECT", "discovery_method": "VISUAL", "location_found": "loc_scene", "related_persons": ["p_julia"], "weight": 0.5, "importance_level": "MAJOR", "legal_categories": ["PRESENCE"]},
		{"id": "ev_phone", "name": "Phone Records", "description": "Calls.", "type": "DIGITAL", "discovery_method": "DIGITAL", "location_found": "loc_office", "related_persons": ["p_julia"], "weight": 0.4, "importance_level": "MINOR", "legal_categories": ["CONNECTION"]},
	],
	"locations": [
