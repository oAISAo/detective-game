...
func test_apply_tokens_sets_list_button_contract() -> void:
	...
	assert_eq(theme.get_color("font_color", "ListButton"), UI_COLORS.TEXT_SECTION_HEADER)
...
func test_apply_tokens_sets_header_variation_values() -> void:
	...
	assert_eq(theme.get_color("font_color", "SectionHeader"), UI_COLORS.TEXT_SECTION_HEADER)
